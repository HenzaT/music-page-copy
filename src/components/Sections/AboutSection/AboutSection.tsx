  ...
  return (
    <div className="about flex-col">
      ...
      <div className="about-text-paragraphs flex-col">
        ...
        <p>If you're a musician and are looking for some inspiration when songwriting, check out another app I built:</p>
        <a href="https://gimme-a-song-75fdbe92334c.herokuapp.com/" target="_blank">
          <span className="weblink">Gimme a Song.</span>
        </a>
        <p>It gives you the perfect starting point for when you're in need of some inspiration.</p>
      </div>
    </div>
  )
}
